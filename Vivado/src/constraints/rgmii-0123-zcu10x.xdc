...
set_input_delay -clock [get_clocks *_gmii_to_rgmii_1_0_rgmii_rx_clk] -max -1.2 [get_ports -of [get_nets -of [get_pins "*/gmii_to_rgmii_1/rgmii_rxd[*] */gmii_to_rgmii_1/rgmii_rx_ctl"]]]
set_input_delay -clock [get_clocks *_gmii_to_rgmii_1_0_rgmii_rx_clk] -min -2.4 [get_ports -of [get_nets -of [get_pins "*/gmii_to_rgmii_1/rgmii_rxd[*] */gmii_to_rgmii_1/rgmii_rx_ctl"]]]
set_input_delay -clock [get_clocks *_gmii_to_rgmii_1_0_rgmii_rx_clk] -clock_fall -max -1.2 -add_delay [get_ports -of [get_nets -of [get_pins "*/gmii_to_rgmii_1/rgmii_rxd[*] */gmii_to_rgmii_1/rgmii_rx_ctl"]]]
set_input_delay -clock [get_clocks *_gmii_to_rgmii_1_0_rgmii_rx_clk] -clock_fall -min -2.4 -add_delay [get_ports -of [get_nets -of [get_pins "*/gmii_to_rgmii_1/rgmii_rxd[*] */gmii_to_rgmii_1/rgmii_rx_ctl"]]]
