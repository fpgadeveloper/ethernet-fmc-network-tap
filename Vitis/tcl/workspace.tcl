...
# Recursive find directory function
# Recursively searches for directory names and returns full paths
# Example usage: glob-dir-r [pwd] src (find all "src" directories in current path)
...
proc create_vitis_ws {vivado_dirs} {
  ...
  foreach {xsa_file} $xsa_files {
    ...
    if {$platform_name in $list_of_platforms} {
      ...
      # we don't know config has been done and what hasn't
